...
const WiFi = () => {
    ...
    function sendData(ev) {
        ...
        fetch(`/connect?wifi=${ssid}&pass=${password}&hideold=1`, {method: "POST"})
    ...
    return (
        <div className={styles.container}>
            ...
            <form onSubmit={sendData}>
                ...
                <input placeholder={"Пароль от сети"} onChange={ev => setPassword(ev.target.value.trim())}
                       value={password}/>
